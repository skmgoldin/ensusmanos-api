...
class GenerateUserTokenRequestHandlerTest {
  ...
  void loginNormalUser() throws UserAuthException {
    ...
    JWTVerifier verifier = JWT.require(algorithm).withIssuer("ensusmanos").build();
  ...
  public static void setup() throws Exception {
    ...
    final CreateTableRequest req =
        CreateTableRequest.builder()
            ...
            .keySchema(kse)
            .tableName(System.getenv("ESM_API_USERS_DB_NAME"))
            .build();
  ...
  public static void teardown() {
    ...
    deleteReqMap.put(System.getenv("ESM_API_USERS_DB_NAME"), deleteReqsList);
    ...
    final DeleteTableRequest req =
        DeleteTableRequest.builder().tableName(System.getenv("ESM_API_USERS_DB_NAME")).build();
